...
public class OllamaController implements IAiService {
    ...
    {
        System.out.println("===== OllamaController is initial =====");
    }
    ...
    public ChatResponse generate(@RequestParam("model") String model, @RequestParam("message") String message) {
        ...
        messages.add(new SystemMessage("You must always respond in English. For mathematical queries, provide a direct, concise numerical answer. Do not explain or elaborate unnecessarily."));
    ...
    */
    ...
    public Flux<ChatResponse> generateStream(@RequestParam("model") String model, @RequestParam("message") String message) {
        // System prompt to ensure English and directness
        List<Message> messages = new ArrayList<>();
        messages.add(new SystemMessage("You must always respond in English. For mathematical question, provide a direct, concise numerical answer. "));
        messages.add(new UserMessage(message));
